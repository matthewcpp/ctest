...
void ctest_runner_process_test_result(_ctest_runner* runner);
void ctest_runner_print_results(_ctest_runner* runner);

_ctest_runner* _ctest_runner_create() {
	_ctest_runner* runner = calloc(1, sizeof(_ctest_runner));
